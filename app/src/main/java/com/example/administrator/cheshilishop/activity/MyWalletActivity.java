...
public class MyWalletActivity extends BaseActivity {
    ...
    RelativeLayout mLayoutCommission;
    ...
    protected void setListener() {
        ...
        mLayoutCommission.setOnClickListener(this);
    ...
    protected void onClickEvent(View paramView) {
        switch (paramView.getId()) {
            case R.id.layout_other://更多
                ...
                break;
            case R.id.layout_commission://佣金
                intent = new Intent(this, CommissionActivity.class);
                startActivity(intent);
                break;
        }
    }
        ...
        RestClient.post(UrlUtils.queryCmnCount(), params, this, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if ("0".equals(Status)) {
                        JSONObject data = jsonObject.getJSONObject("Data");
                        if ("null".equals(data.getString("History_Amount"))) {
                            mTvCommission.setText("¥0");
                        } else {
                            mTvCommission.setText("¥ " + data.getString("History_Amount"));
                        }
